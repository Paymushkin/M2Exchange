<template>
	<div class="flex flex-col items-start justify-center h-full max-w-[420px]">
		...
		<div class="flex flex-wrap justify-center gap-3">
			<div class="flex-item flex-item__wide" @click="selectFile(0)">
				<PlusIcon />
				<input
					type="file"
					accept="image/*"
			...
			<div class="flex-item flex-item__small" @click="selectFile(1)">
				<PlusIcon />
				<input
					type="file"
					accept="image/*"
			...
			<div class="flex-item flex-item__small" @click="selectFile(2)">
				<PlusIcon />
				<input
					type="file"
					accept="image/*"
			...
			<div class="flex-item flex-item__wide" @click="selectFile(3)">
				<PlusIcon />
				<input
					type="file"
					accept="image/*"
					@change="handleFileChange(3)"
					class="hidden"
					ref="fileInput3"
				/>
			</div>
...
const selectFile = (index) => {
	const fileInput =
		index === 0 ? fileInput0 : index === 1 ? fileInput1 : index === 2 ? fileInput2 : fileInput3
