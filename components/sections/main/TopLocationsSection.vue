	...
	<section>
		<div class="container custom-container-2">
			<div class="flex justify-between items-center xl:gap-[400px] gap-5 mb-10">
				<h2 class="2xl:text-[42px] lg:4xl text-2xl leading-[1.2] font-bold text-primary-darker">
					Топ локации
				</h2>
				<div class="flex xl:gap-4 gap-2 items-center cursor-pointer lg:pr-0">
					<span class="2xl:text-2xl xl:text-xl sm:text-base text-xs text-primary"
						>Смотреть все</span
					>
					<SeeAllIcon />
				</div>
			...
			<form>
				<div class="flex xl:gap-10 pb-5 gap-4 overflow-x-auto scrollbar-hide">
					<label
