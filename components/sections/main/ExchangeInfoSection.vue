    ...
    <div class="container mx-auto">
      <div class="flex justify-between gap-5 bg-[#F0F3FE] rounded-[85px] py-16 px-[70px]">
        <div class="flex flex-col items-start gap-6 min-w-[570px]">
            ...
            <h3 class="text-[30px] leading-[40px] text-dark mb-70">
        ...
        <div class="flex flex-col items-start gap-12 grow">
            <div class="border border-primary-lighter rounded-[40px] leading-[30px] py-3 px-5 font-medium text-dark-deeper text-[22px]">
                Обмен недвижимостью
            </div>
          
          <div class="flex flex-col gap-4 text-[19px] leading-[26px] text-dark-deeper">
