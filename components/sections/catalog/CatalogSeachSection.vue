    ...
    <div class="container">
        <div class="flex flex-col justify-center lg:py-12 py-5 w-full">
            ...
            <!-- Фильтры -->
                ...
                >
                    <div class="relative flex flex-col sm:justify-center xl:gap-10 gap-4 lg:border border-[#E4EBFB] rounded-lg p-5 pt-14 xl:p-12 w-full h-full xl:h-auto overflow-y-auto">
