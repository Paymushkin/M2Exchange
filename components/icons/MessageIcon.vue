<template>
	<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
		<g clip-path="url(#clip0_116_26565)">
			<path
				d="M6.875 12.375L9.625 9.625L12.375 12.375L15.125 9.625"
				stroke="currentColor"
