import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrIncludeBooleanAttr, ssrRenderStyle, ssrRenderVNode } from "vue/server-renderer";
import { mergeProps, useSSRContext, ref, unref, withCtx, createTextVNode, toDisplayString, markRaw, createVNode, resolveDynamicComponent } from "vue";
...
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs) {
  _push(`<svg${ssrRenderAttrs(mergeProps({
    ...
    viewBox: "0 0 38 39",
    fill: "none"
  }, _attrs))}><path d="M17.2793 30.5452C24.1459 30.5452 29.7124 24.804 29.7124 17.7218C29.7124 10.6397 24.1459 4.89844 17.2793 4.89844C10.4127 4.89844 4.84619 10.6397 4.84619 17.7218C4.84619 24.804 10.4127 30.5452 17.2793 30.5452Z" stroke="currentColor" stroke-width="4.00731" stroke-linecap="round" stroke-linejoin="round"></path><path opacity="0.4" d="M32.8201 33.7501L26.0596 26.7773" stroke="currentColor" stroke-width="4.00731" stroke-linecap="round" stroke-linejoin="round"></path></svg>`);
}
const _sfc_setup$p = _sfc_main$p.setup;
_sfc_main$p.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/icons/SearchIconForm.vue");
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs) {
  _push(`<svg${ssrRenderAttrs(mergeProps({
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, _attrs))}><circle cx="22.6564" cy="23.1661" r="22.2911" fill="#F0F3FE"></circle><circle cx="22.6563" cy="23.1651" r="11.1456" fill="#6284FF"></circle></svg>`);
}
const _sfc_setup$o = _sfc_main$o.setup;
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/icons/SearchIconBackground.vue");
  return _sfc_setup$o ? _sfc_setup$o(props, ctx) : void 0;
};
const SearchIconBackground = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$n = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        class: ["flex items-center gap-3 bg-primary text-white rounded-[60px] py-4 px-8 hover:bg-primary-dark transition-colors", { "w-[282px]": __props.isWide }]
      }, _attrs))}>`);
...
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/buttons/ExchangeButton.vue");
...
const _sfc_main$m = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-[1px] h-[32px] bg-[#7974E7]"></div><input type="text" placeholder="Поиск" class="flex-1 px-4 max-w-[260px] outline-none text-[22px] leading-[32px] text-dark"></div><button type="submit" class="text-dark-deep rounded-[8px] text-[25px] leading-[34px] transition-colors hover:text-primary"> Найти </button></div>`);
      _push(ssrRenderComponent(_sfc_main$n, { isWide: "" }, null, _parent));
      _push(`</div></div><div class="max-w-[40%] xl:w-[800px]"><img${ssrRenderAttr("src", _imports_0)} alt="Обмен недвижимостью" class="w-full rounded-[20px]"></div></div></div></section>`);
    };
  }
};
...
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/main/HeroSection.vue");
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  _push(`<svg${ssrRenderAttrs(mergeProps({
    ...
    viewBox: "0 0 23 22",
    fill: "none"
  }, _attrs))}><rect x="0.841797" y="0.375" width="21.2143" height="21.2143" rx="5.30357" fill="#3D62FF"></rect><rect x="6.14844" y="5.67822" width="10.6071" height="10.6071" rx="1.76786" fill="white"></rect></svg>`);
}
const _sfc_setup$j = _sfc_main$j.setup;
_sfc_main$j.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/icons/SquareIcon.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<li${ssrRenderAttrs(mergeProps({
        class: ["relative w-[350px] bg-white rounded-[60px] p-6 object-item", { "favorite-object": unref(isFavorite)(__props.card.id) }]
      }, _attrs))} data-v-930f86e1><img${ssrRenderAttr("src", __props.card.image)}${ssrRenderAttr("alt", __props.card.title)} class="w-full h-auto rounded-lg mb-3" data-v-930f86e1><div class="${ssrRenderClass([{ "is-favorite": unref(isFavorite)(__props.card.id) }, "absolute top-12 right-12 flex items-center justify-center rounded-full icon-heart cursor-pointer"])}" data-v-930f86e1>`);
      _push(ssrRenderComponent(HeartIcon, { class: "h-6" }, null, _parent));
      _push(`</div><div class="flex items-center mb-3 gap-2 justify-between text-[24px]" data-v-930f86e1><p class="font-semibold" data-v-930f86e1>${ssrInterpolate(__props.card.title)}</p><p class="text-primary-lighter font-semibold" data-v-930f86e1>$${ssrInterpolate(__props.card.price)}</p></div><div class="flex items-center mb-3" data-v-930f86e1>`);
      _push(ssrRenderComponent(LocationIcon, null, null, _parent));
      _push(`<span class="ml-1 text-[18px]" data-v-930f86e1>${ssrInterpolate(__props.card.location)}</span></div><div class="flex items-center gap-2" data-v-930f86e1><div class="flex items-center grow mt-2" data-v-930f86e1>`);
      _push(ssrRenderComponent(SquareIcon, null, null, _parent));
      _push(`<span class="ml-1" data-v-930f86e1>${ssrInterpolate(__props.card.area)}m²</span></div><div class="flex items-center grow mt-2" data-v-930f86e1>`);
      _push(ssrRenderComponent(BedIcon, null, null, _parent));
      _push(`<span class="ml-1" data-v-930f86e1>${ssrInterpolate(__props.card.beds)}</span></div><div class="flex items-center grow mt-2" data-v-930f86e1>`);
      _push(ssrRenderComponent(BathIcon, null, null, _parent));
      _push(`<span class="ml-1" data-v-930f86e1>${ssrInterpolate(__props.card.baths)}</span></div></div></li>`);
    };
  }
};
...
_sfc_main$g.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/main/ObjectCard.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(cards, (card) => {
        _push(ssrRenderComponent(ObjectCard, {
          key: card.id,
          card
        }, null, _parent));
      });
...
_sfc_main$e.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/main/ExchangeInfoSection.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<svg${ssrRenderAttrs(mergeProps({
    ...
    viewBox: "0 0 42 29",
    fill: "none"
  }, _attrs))}><path fill-rule="evenodd" clip-rule="evenodd" d="M28.2285 0.741132L40.5548 13.0675C41.3112 13.8239 41.3112 15.0502 40.5548 15.8067L28.2285 28.133C27.4721 28.8894 26.2457 28.8894 25.4893 28.133C24.7329 27.3766 24.7329 26.1502 25.4893 25.3938L34.5091 16.374H0.447266V12.5002H34.5091L25.4893 3.48032C24.7329 2.72391 24.7329 1.49754 25.4893 0.741132C26.2457 -0.0152733 27.4721 -0.0152733 28.2285 0.741132Z" fill="#6284FF"></path></svg>`);
}
const _sfc_setup$d = _sfc_main$d.setup;
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/icons/ArrowIcon.vue");
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/main/ExchangeProcess.vue");
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/slides/Slide1.vue");
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center h-full" }, _attrs))} data-v-a1add007><h2 class="custom-title mb-6 text-center" data-v-a1add007>Где находится объект?</h2><p class="description text-base mb-6 text-center" data-v-a1add007> Введите адрес или выберите зону на карте </p><div class="flex items-center w-[480px] border border-[#ECEDF3] rounded-[40px] py-4 px-5" data-v-a1add007>`);
      _push(ssrRenderComponent(LocationIcon, { class: "mr-2" }, null, _parent));
      _push(`<select class="mr-2 text-[18px] cursor-pointer" data-v-a1add007><option value="location1" data-v-a1add007>Italy, Sardinia</option><option value="location2" data-v-a1add007>Spain, Barcelona</option><option value="location3" data-v-a1add007>France, Paris</option></select><button class="flex items-center ml-auto bg-primary-dark text-white text-[12px] px-5 py-3 rounded-full hover:bg-blue-700 transition" data-v-a1add007>`);
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/slides/Slide2.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/RadioButton.vue");
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center max-w-[970px] h-full" }, _attrs))} data-v-79c14eca><h2 class="custom-title mb-6 text-center" data-v-79c14eca>Тип объекта</h2><p class="description text-base mb-6 text-center" data-v-79c14eca> Выберите одну или несколько категорий интересующей вас недвижимости </p><div class="flex flex-wrap justify-center gap-4" data-v-79c14eca><!--[-->`);
      ssrRenderList(buttons, (button) => {
        _push(ssrRenderComponent(RadioButton, {
          key: button.value,
          value: button.value,
          name: "property-type",
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/slides/Slide3.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/slides/Slide4.vue");
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-aa81697d><h2 data-v-aa81697d>Слайд 5</h2><p data-v-aa81697d>Содержимое первого слайда.</p></div>`);
    };
  }
};
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/slides/Slide5.vue");
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-01eeca6b><h2 data-v-01eeca6b>Слайд 6</h2><p data-v-01eeca6b>Содержимое первого слайда.</p></div>`);
    };
  }
};
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/slides/Slide6.vue");
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-c9f40ca7><h2 data-v-c9f40ca7>Слайд 7</h2><p data-v-c9f40ca7>Содержимое первого слайда.</p></div>`);
    };
  }
};
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/slides/Slide7.vue");
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-e03230fe><h2 data-v-e03230fe>Слайд 8</h2><p data-v-e03230fe>Содержимое первого слайда.</p></div>`);
    };
  }
};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/slides/Slide8.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "slide w-full py-8 px-10 max-w-[1360px] min-h-[720px] mx-auto rounded-[50px] overflow-hidden bg-white flex flex-col" }, _attrs))} data-v-a6e51e47><header class="slider-header flex items-center justify-between" data-v-a6e51e47>`);
      _push(ssrRenderComponent(LogoIcon, null, null, _parent));
      _push(`</header><div class="slider-content flex-grow flex items-center justify-center" data-v-a6e51e47>`);
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(currentSlide.value), null, null), _parent);
      _push(`</div><footer class="slider-footer flex items-center gap-7" data-v-a6e51e47><div class="pagination flex gap-1 grow" data-v-a6e51e47><!--[-->`);
      ssrRenderList(slides, (slide, index2) => {
        _push(`<div class="${ssrRenderClass([{ "bg-primary": currentIndex.value === index2, "bg-[#E9ECFF]": currentIndex.value !== index2 }, "bullet h-[5px] grow rounded transition-colors duration-300"])}" data-v-a6e51e47></div>`);
      });
      _push(`<!--]--></div><button class="min-w-[140px] h-[50px] bg-primary-dark text-white text-[18px] px-4 py-2 rounded-[40px] hover:bg-blue-700" data-v-a6e51e47>${ssrInterpolate(currentIndex.value === slides.length - 1 ? "Отправить" : "Далее")}</button></footer></div>`);
    };
  }
};
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="container" data-v-a7a089e5><div class="py-12 bg-[#EFF3FF] rounded-[80px]" data-v-a7a089e5>`);
