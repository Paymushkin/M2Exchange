import { mergeProps, withCtx, createVNode, useSSRContext, ref, resolveComponent, resolveDynamicComponent, openBlock, createBlock, toDisplayString } from "vue";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderVNode, ssrRenderSlot } from "vue/server-renderer";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        to: "/",
        class: ["flex items-center space-x-2", { "cursor-pointer": _ctx.$route.path !== "/", "cursor-default": _ctx.$route.path === "/" }],
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(navigationItems, (item) => {
        _push(`<a${ssrRenderAttr("href", item.href)} class="text-[#171652] hover:text-[#171652]/80">${ssrInterpolate(item.text)}</a>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const _sfc_main$i = {
  ...
  setup(__props, { emit: __emit }) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({ class: "flex flex-col gap-[8px] cursor-pointer relative w-[28px] h-[20px]" }, _attrs))} data-v-dd6be091><span class="${ssrRenderClass([{
        "rotate-45 top-[8px]": __props.isOpen,
        "top-0": !__props.isOpen
      }, "absolute w-[24px] h-[3px] bg-dark rounded-full transition-all duration-300"])}" data-v-dd6be091></span><span class="${ssrRenderClass([{ "opacity-0": __props.isOpen }, "absolute w-[19px] h-[3px] bg-dark rounded-full top-[8px] transition-all duration-300"])}" data-v-dd6be091></span><span class="${ssrRenderClass([{
        "-rotate-45 top-[8px]": __props.isOpen,
        "top-[16px]": !__props.isOpen
      }, "absolute w-[24px] h-[3px] bg-dark rounded-full transition-all duration-300"])}" data-v-dd6be091></span></button>`);
    };
  }
};
...
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/MenuButton.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_router_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", isAuthenticated.value ? "/images/avatars/avatar.png" : "/images/avatars/default-avatar.svg")}${ssrRenderAttr("alt", isAuthenticated.value ? "User avatar" : "Default avatar")} class="min-w-[46px] h-[46px] aspect-square rounded-full object-cover"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: isAuthenticated.value ? "/images/avatars/avatar.png" : "/images/avatars/default-avatar.svg",
      ...
      if (notificationsCount.value > 0) {
        _push(`<div class="absolute top-0 right-0 w-[14px] h-[14px] bg-[#FE8A71] rounded-full flex items-center justify-center"><span class="text-white text-[10px] leading-none">${ssrInterpolate(notificationsCount.value)}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
function _sfc_ssrRender$b(_ctx, _push, _parent, _attrs) {
  _push(`<svg${ssrRenderAttrs(mergeProps({
    ...
    viewBox: "0 0 20 20",
    fill: "none"
  }, _attrs))}><path d="M10.1342 9.06024C10.0509 9.0519 9.95091 9.0519 9.85924 9.06024C8.90275 9.02776 7.99645 8.62427 7.33227 7.9352C6.66809 7.24614 6.2982 6.32561 6.30091 5.36857C6.30091 3.3269 7.95091 1.66857 10.0009 1.66857C10.4863 1.65982 10.9686 1.74674 11.4203 1.92439C11.8721 2.10203 12.2844 2.36691 12.6338 2.70391C12.9832 3.04091 13.2627 3.44343 13.4566 3.88848C13.6504 4.33353 13.7547 4.81239 13.7634 5.29774C13.7722 5.78308 13.6852 6.2654 13.5076 6.71715C13.33 7.1689 13.0651 7.58123 12.7281 7.93061C12.3911 8.27999 11.9886 8.55958 11.5435 8.7534C11.0985 8.94722 10.6196 9.05148 10.1342 9.06024ZM5.96758 12.1352C3.95091 13.4852 3.95091 15.6852 5.96758 17.0269C8.25924 18.5602 12.0176 18.5602 14.3092 17.0269C16.3259 15.6769 16.3259 13.4769 14.3092 12.1352C12.0259 10.6102 8.26758 10.6102 5.96758 12.1352Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path></svg>`);
}
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs) {
  _push(`<svg${ssrRenderAttrs(mergeProps({
    ...
    viewBox: "0 0 19 19",
    fill: "none"
  }, _attrs))}><path d="M9.71924 16.063L16.3514 9.3358C17.0475 8.63977 17.4385 7.69576 17.4385 6.71143C17.4385 5.7271 17.0475 4.78308 16.3514 4.08705C15.6554 3.39102 14.7114 3 13.7271 3C12.7427 3 11.7987 3.39102 11.1027 4.08705L9.71924 5.37549L8.3358 4.08705C7.63977 3.39102 6.69576 3 5.71143 3C4.7271 3 3.78308 3.39102 3.08705 4.08705C2.39102 4.78308 2 5.7271 2 6.71143C2 7.69576 2.39102 8.63977 3.08705 9.3358L9.71924 16.063Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path></svg>`);
}
const _sfc_setup$b = _sfc_main$b.setup;
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/icons/FavoritesIcon.vue");
...
const _sfc_main$8 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><nav class="flex flex-col gap-4"><!--[-->`);
      ssrRenderList(menuItems, (item, index) => {
        ...
        _push(ssrRenderComponent(_component_router_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(item.icon), { class: "w-5 h-5 text-primary group-hover:text-primary" }, null), _parent2, _scopeId);
              _push2(`<span class="text-dark group-hover:text-primary text-[13px] leading-[20px]"${_scopeId}>${ssrInterpolate(item.name)}</span>`);
            } else {
              return [
                (openBlock(), createBlock(resolveDynamicComponent(item.icon), { class: "w-5 h-5 text-primary group-hover:text-primary" })),
                createVNode("span", { class: "text-dark group-hover:text-primary text-[13px] leading-[20px]" }, toDisplayString(item.name), 1)
              ];
            }
          }),
          _: 2
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/HeaderMenu.vue");
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex items-center gap-5" }, _attrs))}><div class="flex items-center gap-2"><!--[-->`);
      ssrRenderList(actions, (action, index) => {
        _push(`<button class="text-gray-600 hover:text-gray-900">`);
        ssrRenderVNode(_push, createVNode(resolveDynamicComponent(action.icon), null, null), _parent);
        _push(`</button>`);
      });
      _push(`<!--]--></div><div class="relative"><div class="flex justify-between items-center gap-[22px] py-[6px] pl-[22px] pr-[12px] bg-white rounded-[40px] w-[115px]">`);
      _push(ssrRenderComponent(MenuButton, {
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/TheHeaderActions.vue");
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "w-full bg-primary-light rounded-b-[36px] relative z-40" }, _attrs))}><div class="container mx-auto px-4"><nav class="flex items-center py-5">`);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<svg${ssrRenderAttrs(mergeProps({
    ...
    viewBox: "0 0 21 21",
    fill: "none"
  }, _attrs))}><path d="M1 10.5H20" stroke="black" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10.5 20C15.7467 20 20 15.7467 20 10.5C20 5.25329 15.7467 1 10.5 1C5.25329 1 1 5.25329 1 10.5C1 15.7467 5.25329 20 10.5 20Z" stroke="black" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path><path d="M14.4557 10.5C14.4557 16.8333 10.4974 20 10.4974 20C10.4974 20 6.53906 16.8333 6.53906 10.5C6.53906 4.16667 10.4974 1 10.4974 1C10.4974 1 14.4557 4.16667 14.4557 10.5Z" stroke="black" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path></svg>`);
}
const _sfc_setup$3 = _sfc_main$3.setup;
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/icons/GlobeIconMini.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<svg${ssrRenderAttrs(mergeProps({
    ...
    viewBox: "0 0 15 15",
    fill: "none"
  }, _attrs))}><g clip-path="url(#clip0_116_26602)"><path d="M12.1875 5.625L7.5 10.3125L2.8125 5.625" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></g><defs><clipPath id="clip0_116_26602"><rect width="15" height="15" fill="white"></rect></clipPath></defs></svg>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-footer py-12 rounded-t-[30px]" }, _attrs))} data-v-0ebbb638><div class="container mx-auto flex flex-col items-center" data-v-0ebbb638><div class="flex items-center w-full mb-[72px]" data-v-0ebbb638>`);
      _push(ssrRenderComponent(_sfc_main$n, { class: "mr-[78px]" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$m, null, null, _parent));
      _push(`<div class="flex items-center ml-auto gap-10" data-v-0ebbb638><span class="text-black text-[16px] font-bold" data-v-0ebbb638>Social</span><div class="flex items-center gap-4" data-v-0ebbb638><a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" data-v-0ebbb638>`);
      _push(ssrRenderComponent(InstagramIcon, null, null, _parent));
      _push(`</a><a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" data-v-0ebbb638>`);
      _push(ssrRenderComponent(FacebookIcon, null, null, _parent));
      _push(`</a></div></div></div><div class="w-full h-[1px] bg-gray-200" data-v-0ebbb638></div><div class="flex items-center mt-5 w-full text-center text-gray-600" data-v-0ebbb638><p data-v-0ebbb638>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} <b data-v-0ebbb638>m2 exchange</b></p><div class="flex ml-[95px] gap-9" data-v-0ebbb638><a href="/privacy" class="hover:underline" data-v-0ebbb638>Конфиденциальность</a><a href="/terms" class="hover:underline" data-v-0ebbb638>Условия</a><a href="/download" class="hover:underline" data-v-0ebbb638>Скачать приложение</a></div><div class="flex items-center ml-auto gap-8" data-v-0ebbb638><div class="flex items-center gap-2" data-v-0ebbb638>`);
      _push(ssrRenderComponent(GlobeIconMini, null, null, _parent));
      _push(`<span class="ml-1" data-v-0ebbb638>Русский</span></div><div class="flex items-center gap-2" data-v-0ebbb638><span class="ml-1" data-v-0ebbb638>Поддержка и вопросы</span>`);
