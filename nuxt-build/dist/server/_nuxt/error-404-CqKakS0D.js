...
const _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(
				`<div${ssrRenderAttrs(mergeProps({ class: 'antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black' }, _attrs))} data-v-c2c324f7><div class="fixed left-0 right-0 spotlight z-10" data-v-c2c324f7></div><div class="max-w-520px text-center z-20" data-v-c2c324f7><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-c2c324f7>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-c2c324f7>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-c2c324f7>`
			)
			_push(
				ssrRenderComponent(
					_component_NuxtLink,
...
//# sourceMappingURL=error-404-CqKakS0D.js.map
